    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <section id="sobre" style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px', padding: '30px' }}>
          ...
          <div style={{ 
            backgroundImage: 'url("https://images.unsplash.com/photo-1630930678172-63343537a00a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8bmVnJUMzJUIzY2lvcyUyMG0lQzMlQTFxdWluYXMlMjBkZSUyMGNvc3R1cmF8ZW58MHx8MHx8fDA%3D")', 
            backgroundSize: 'cover', backgroundPosition: 'center', borderRadius: '8px', marginTop: '40px'
